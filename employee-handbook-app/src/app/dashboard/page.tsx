        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white px-8 py-4">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <div className="relative group">
              ...
              {employeeCount === 0 && (
                <>
                                      <div className="absolute right-full top-1/2 transform -translate-y-1/2 mr-2 px-3 py-2 bg-gray-800 text-white text-xs rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50 w-48 text-center shadow-lg lg:hidden">
                    ...
                    <div className="hidden lg:block absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-3 py-2 bg-gray-800 text-white text-sm rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50 whitespace-nowrap text-center shadow-lg">
                      Add employees first to enable premium features

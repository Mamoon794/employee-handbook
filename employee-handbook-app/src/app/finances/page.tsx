...
export default function Finances() {
  ...
  const getSubscriptionStatus = () => {
    if (!subscriptionData)
      return { status: "loading", color: "gray", icon: Clock }
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Manage your Employee Handbook membership
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-900">
                      {loadingEmployeeCount
                        ? "Loading..."
                        : `$${getPricingForEmployeeCount(employeeCount).toFixed(
                            2
                          )}/month`}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-blue-600">
                      {loadingEmployeeCount
                        ? "Loading..."
                        : `$${calculateMonthlyTotal(employeeCount).toFixed(
                            2
                          )} USD`}
                    </span>
                  </div>
                ...
                >
                  {processingCheckout ? (
                    ...
                    <>
                      ...
                      Upgrade to Premium - $
                      {calculateMonthlyTotal(employeeCount).toFixed(2)}/month
                    </>
                  )}
                </button>
              )}
        ...
        <div className="bg-white rounded-xl shadow-sm border mb-8">
          <div className="p-6 border-b">
            ...
            <p className="text-gray-600 mt-1">
              Monthly pricing based on number of employees
            </p>
          </div>
          <div className="p-6">
              ...
              <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <div className="flex items-center">
                  ...
                  <p className="text-yellow-800 text-sm">
                    No employees found in your organization. Add employees to
                    see your pricing tier.
                  </p>
                </div>
              </div>
            )}
